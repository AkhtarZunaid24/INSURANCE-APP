...
const features = [
  {
    ...
    description: 'Comprehensive health protection for on-the-job accidents, including emergency care and rehabilitation.',
    icon: HeartPulse,
    color: 'text-red-600',
    bg: 'bg-red-50',
  },
  {
    ...
    description: 'Up to $1M in coverage for third-party property damage or bodily injury while you are delivering.',
    icon: ShieldAlert,
    color: 'text-blue-600',
    bg: 'bg-blue-50',
  },
  {
    ...
    description: 'Protection for your bike, scooter, or car against theft, vandalism, and collision damage.',
    icon: Bike,
